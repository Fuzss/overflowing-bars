package fuzs.overflowingbars.common.config;
...
public class ClientConfig implements ConfigCore {
     ...
     */
    private static final String ALLOW_LAYERS_DESCRIPTION = "Add layers to this bar. When disabled any modifications to the bar from this mod will be turned off.";
    ...
    public static class HealthRowConfig extends IconRowConfig {
        @Config(description = ALLOW_LAYERS_DESCRIPTION, gameRestart = true)
    ...
    public static class ToughnessRowConfig extends AbstractArmorRowConfig {
        @Config(description = ALLOW_LAYERS_DESCRIPTION)
    ...
    public static class RowCountConfig implements ConfigCore {
        ...
        public DyeColor rowCountColor = DyeColor.WHITE;
